...
struct ptr_unary_operation
{
	...
	inline constexpr CPP1X_DELEGATE_FUNCTION(operator()(_T* v) const,
																					 _operation(*v))

	inline CPP1X_DELEGATE_FUNCTION(operator()(_T* v), _operation(*v))

	inline constexpr CPP1X_DELEGATE_FUNCTION(operator()(const _T* v) const,
																					 _operation(*v))

	inline CPP1X_DELEGATE_FUNCTION(operator()(const _T* v), _operation(*v))
};
...
struct ptr_binary_operation
{
	...
	inline constexpr CPP1X_DELEGATE_FUNCTION(operator()(_T* v, _U* v2) const,
																					 _operation(*v, *v2))

	inline CPP1X_DELEGATE_FUNCTION(operator()(_T* v, _U* v2), _operation(*v, *v2))

	inline constexpr CPP1X_DELEGATE_FUNCTION(operator()(const _T* v, const _U* v2) const,
																					 _operation(*v, *v2))

	inline CPP1X_DELEGATE_FUNCTION(operator()(const _T* v, const _U* v2),
																 _operation(*v, *v2))
};
...
struct indirect_binary_operation
{
	...
	inline CPP1X_DELEGATE_FUNCTION(operator()(_T& v, _U& v2),
																 _operation(_indirect(v), _indirect(v2)))
