namespace operators {
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR()); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), l); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), r); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), a); }

	template<int _Num, typename _T>
	inline constexpr typename std::enable_if<!is_placeholder<_T>::value && !std::is_bind_expression<_T>::value && std::is_rvalue_reference<_T&&>::value, ___lambda<__FALCON_NAME_OPERATOR, _T, placeholder<_Num> > >::type operator __FALCON_SIGN_OPERATOR(_T CPP0X_RVALUE_REF a, const placeholder<_Num>&)
	{ return CPP0X(__FALCON_NAME_OPERATOR(), a); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), __bind); }

	template<int _Num, typename _Bind>
	inline constexpr typename std::enable_if<std::is_bind_expression<_Bind>::value && std::is_rvalue_reference<_Bind&&>::value, ___lambda<__FALCON_NAME_OPERATOR, __pair<_Bind&, placeholder<_Num> >, binder> >::type operator __FALCON_SIGN_OPERATOR(_Bind CPP0X_RVALUE_REF __bind, const placeholder<_Num>&)
	{ return CPP0X(__FALCON_NAME_OPERATOR(), __bind); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), b); }

	template<int _Num, typename _T>
	inline constexpr typename std::enable_if<!is_placeholder<_T>::value && !std::is_bind_expression<_T>::value && std::is_rvalue_reference<_T&&>::value, ___lambda<__FALCON_NAME_OPERATOR, placeholder<_Num>, _T> >::type operator __FALCON_SIGN_OPERATOR(const placeholder<_Num>&, _T CPP0X_RVALUE_REF b)
	{ return CPP0X(__FALCON_NAME_OPERATOR(), b); }
	...
	template<int _Num, typename _Bind>
	inline constexpr typename std::enable_if<std::is_bind_expression<_Bind>::value && std::is_rvalue_reference<_Bind&&>::value, ___lambda<__FALCON_NAME_OPERATOR, __pair<placeholder<_Num>, _Bind>, binder> >::type operator __FALCON_SIGN_OPERATOR(const placeholder<_Num>&, _Bind CPP0X_RVALUE_REF __bind)
	{ return CPP0X(__FALCON_NAME_OPERATOR(), __bind); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), left, right); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), l,b); }

	template<typename _T, typename _Operation, typename _TL, typename _UL>
	inline constexpr typename std::enable_if</* !is_placeholder<_T>::value*/ std::is_rvalue_reference<_T&&>::value, ___lambda<__FALCON_NAME_OPERATOR, ___lambda<_Operation, _TL, _UL>, _T> >::type operator __FALCON_SIGN_OPERATOR(___lambda<_Operation, _TL, _UL> l, _T CPP0X_RVALUE_REF b)
	{ return CPP0X(__FALCON_NAME_OPERATOR(), l,b); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), a,l); }

	template<typename _T, typename _Operation, typename _TL, typename _UL>
	inline constexpr typename std::enable_if</* !is_placeholder<_T>::value*/ std::is_rvalue_reference<_T&&>::value,  ___lambda<__FALCON_NAME_OPERATOR, _T, ___lambda<_Operation, _TL, _UL> > >::type operator __FALCON_SIGN_OPERATOR(_T CPP0X_RVALUE_REF a, ___lambda<_Operation, _TL, _UL> l)
	{ return CPP0X(__FALCON_NAME_OPERATOR(), a,l); }
	...
	{ return CPP0X(__FALCON_NAME_OPERATOR(), __bind, __bind2); }
}